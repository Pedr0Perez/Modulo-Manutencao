...
class Exceptions
{
    ...
    private function validarToken()
    {
        try {
            ...
            return isset($query) ? $tokenDescriptografado : NULL;
        } catch (Exception $e) {
            return NULL;
        }
    }
    ...
    private function registrarLog(int $operacao, int $modulo, int $userId, int $httpCodigo, ?string $descricao): void
    {
    ...
    public function exceptionHandler(Throwable $exception)
    {
        ...
        //     $this->registrarLog(0, 1, $tokenDescriptografado->userId ?? -2, 500, "Erro 500. Message: " . $exception->getMessage() . ". File: " . $exception->getFile() . ". Line: " . $exception->getLine() . ". Trace: " . self::renderBacktrace($exception->getTrace()));
        // }
